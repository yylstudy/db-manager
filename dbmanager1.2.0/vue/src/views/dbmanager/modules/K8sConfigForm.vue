    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="nfs ip" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="nfsSshIp">
              <a-input v-model="model.nfsSshIp" placeholder="请输入nfs ip"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="nfs端口" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="nfsSshPort">
              <a-input v-model="model.nfsSshPort" placeholder="请输入nfs端口"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="nfs用户" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="nfsSshUser">
              <a-input v-model="model.nfsSshUser" placeholder="请输入nfs用户"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="nfs密码" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="nfsSshPassword">
              <a-input v-model="model.nfsSshPassword" type="password" placeholder="请输入nfs密码"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="nfs数据基础目录" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="nfsBaseDir">
              <a-input v-model="model.nfsBaseDir" placeholder="请输入nfs数据基础目录"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24" >
