...
CREATE TABLE `k8s_config`  (
  ...
  create_time datetime,
	nfs_ssh_ip varchar(50) COMMENT 'nfs ip地址',
	nfs_ssh_port varchar(50) COMMENT 'nfs 端口',
	nfs_ssh_user varchar(50) COMMENT 'nfs 用户',
	nfs_ssh_password varchar(50) COMMENT 'nfs 密码',
	nfs_base_dir varchar(50) COMMENT 'nfs 基础目录',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
