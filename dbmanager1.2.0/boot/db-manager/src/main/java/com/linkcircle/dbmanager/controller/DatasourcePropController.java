...
public class DatasourcePropController {
    ...
    @RequestMapping(value = "/getDatasourcePropK8sConfig")
    public Result<?> getDatasourcePropK8sConfig(@RequestParam Long id) {
        ...
        if(CommonConstant.DATASOURCE_K8S.equals(datasourceProp.getIsk8s())){
            ...
            datasourceProp.setNfsBaseDir(k8sConfig.getNfsBaseDir());
        }
        return Result.OK(datasourceProp);
    }
