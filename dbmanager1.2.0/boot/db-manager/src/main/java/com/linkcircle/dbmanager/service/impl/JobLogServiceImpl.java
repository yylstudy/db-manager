    ...
    public IPage<Map<String, String>> getIbdFrm(Page<Map<String, String>> page, Long id) {
        ...
        try{
            ...
            if(CommonConstant.DATASOURCE_K8S.equals(prop.getIsk8s())){
                K8sConfig k8sConfig = k8sConfigService.getById(prop.getK8sConfigId());
                session = SshUtil.getSession(k8sConfig.getNfsSshIp(),k8sConfig.getNfsSshPort(), k8sConfig.getNfsSshUser(), k8sConfig.getNfsSshPassword());
            }else{
