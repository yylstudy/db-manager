package com.linkcircle.system.model;
...
public class DuplicateCheckVo implements Serializable {
	 ...
	 * 字段名
	 */
	@ApiModelProperty(value="逻辑删除字段名",name="fieldName",example="del_flag")
	private String delFieldName;

	/**
	 * 字段值
	 */
	@ApiModelProperty(value="逻辑删除字段值",name="fieldVal",example="0")
	private String delFieldVal;
