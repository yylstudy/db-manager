...
import com.linkcircle.boot.common.constant.CacheConstant;
import com.linkcircle.boot.common.constant.CommonConstant;
import com.linkcircle.boot.common.system.vo.LoginUser;
import com.linkcircle.boot.common.system.vo.SysUserCacheInfo;
import com.linkcircle.boot.common.util.PasswordUtil;
import com.linkcircle.boot.common.util.UUIDGenerator;
import com.linkcircle.boot.common.util.oConvertUtils;
import com.linkcircle.boot.service.BaseCommonService;
import com.linkcircle.system.entity.*;
import com.linkcircle.system.mapper.*;
import com.linkcircle.system.model.SysUserSysDepartModel;
import com.linkcircle.system.service.ISysBaseAPI;
import com.linkcircle.system.service.ISysUserService;
import com.linkcircle.system.vo.SysUserDepVo;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
	...
	public boolean deleteUser(String userId) {
		...
		// 2. 删除用户部门关系
		sysUserDepartMapper.delete(new LambdaQueryWrapper<SysUserDepart>().in(SysUserDepart::getUserId, userId));
		//3. 删除用户角色关系
	...
	public boolean deleteBatchUsers(String userIds) {
		...
		// 2. 删除用户部门关系
		sysUserDepartMapper.delete(new LambdaQueryWrapper<SysUserDepart>().in(SysUserDepart::getUserId, userIds.split(",")));
		//3. 删除用户角色关系
		sysUserRoleMapper.delete(new LambdaQueryWrapper<SysUserRole>().in(SysUserRole::getUserId, userIds.split(",")));
		return false;
	}
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	public List<SysUser> queryUserByRoleCode(String roleCode) {
		return this.baseMapper.queryUserByRoleCode(roleCode);
	}
}
