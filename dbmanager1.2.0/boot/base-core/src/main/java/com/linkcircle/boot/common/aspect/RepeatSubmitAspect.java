...
public class RepeatSubmitAspect {
    ...
    private String parseContent(Method method, Object[] args,String content){
        GenericTokenParser genericTokenParser = new GenericTokenParser("${", "}", fillContent->{
            Map<String,RepeatSubmitContent> WaterLogParserMap = map.computeIfAbsent(method,key->new ConcurrentHashMap<>());
            RepeatSubmitContent waterLogContent = WaterLogParserMap.computeIfAbsent(fillContent,key2->resolveValue(method,key2));
