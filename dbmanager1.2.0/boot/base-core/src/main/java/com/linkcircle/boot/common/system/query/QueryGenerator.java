package com.linkcircle.boot.common.system.query;
...
import com.linkcircle.boot.common.system.vo.SysPermissionDataRuleModel;
...
import com.linkcircle.boot.common.system.util.DataAutorUtils;
...
public class QueryGenerator {
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap(List<SysPermissionDataRuleModel> list) {
		Map<String, SysPermissionDataRuleModel> ruleMap = new HashMap<String, SysPermissionDataRuleModel>();
		if(list==null){
			list = DataAutorUtils.loadDataSearchConditon();
		}
		if(list != null&&list.size()>0){
			if(list.get(0)==null){
				return ruleMap;
