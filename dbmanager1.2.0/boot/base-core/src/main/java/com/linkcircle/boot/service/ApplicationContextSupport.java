 ...
 * @Version: 1.0
 */
@Component("applicationContextSupport")
public class ApplicationContextSupport implements ApplicationContextAware, EnvironmentAware {
    ...
    public void setEnvironment(Environment environment) {
        ApplicationContextSupport.environment = environment;
    }
    @Override
