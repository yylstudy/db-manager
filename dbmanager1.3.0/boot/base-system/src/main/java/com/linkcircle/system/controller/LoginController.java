...
import com.linkcircle.boot.common.util.*;
import com.linkcircle.boot.common.util.encryption.EncryptedString;
...
import com.linkcircle.system.model.SysLoginModel;
import com.linkcircle.system.service.*;
import com.linkcircle.system.util.RandImageUtil;
	...
	public Result<String> sms(@RequestBody JSONObject jsonObject) {
		...
		try {
			...
			if (CommonConstant.SMS_TPL_TYPE_1.equals(smsmode)) {
				...
				b = commonService.sendSms(mobile,"您的验证码为:"+captcha+"(5分钟内有效),如非本人操作，请忽略本短信");
			}else {
				//登录模式，校验用户有效性
				SysUser sysUser = sysUserService.getUserByPhone(mobile);
				result = sysUserService.checkUserIsEffective(sysUser);
