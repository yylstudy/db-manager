...
import com.linkcircle.system.model.SysDictTree;
import com.linkcircle.system.model.TreeSelectModel;
import com.linkcircle.system.vo.SysDictPage;
...
import com.linkcircle.boot.common.system.vo.DictQuery;
import com.linkcircle.boot.common.system.vo.LoginUser;
import com.linkcircle.boot.common.util.ImportExcelUtil;
import com.linkcircle.boot.common.util.SqlInjectionUtil;
import com.linkcircle.boot.common.util.oConvertUtils;
import com.linkcircle.system.service.ISysDictItemService;
...
public class SysDictController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "getDictByTableNgAlain", method = RequestMethod.GET)
	public Result<?> getDictByTableNgAlain( @RequestParam String table, @RequestParam String key, @RequestParam String value) {
		try {
			sysDictService.getDictByTableNgAlain(table,key,value);
			return Result.OK("操作成功!");
		} catch (Exception e) {
			return Result.error("操作失败!");
		}
