...
import com.linkcircle.boot.common.system.vo.DictModelMany;
...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements ISysDictService {
	...
	@Override
	public List<Map<String, String>> getDictByTableNgAlain(String table, String key, String value) {
		return this.sysDictMapper.getDictByTableNgAlain(table,key,value);
	}
}
