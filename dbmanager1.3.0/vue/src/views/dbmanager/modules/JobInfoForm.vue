...
<!--            </a-form-model-item>-->
            <a-form-model-item label="Cron*" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="jobCron">
              <a-row>
                <a-col :span="20">
                  <a-input v-model="model.jobCron" placeholder="请输入Cron"></a-input>
                </a-col>
                <a-col :span="4">
                  <a style="margin-left: 8px" @click="showCronF">选择cron</a>
                </a-col>
              </a-row>
            </a-form-model-item>
    ...
    methods: {
      ...
      changeTaskType(selectedValue){
        ...
        if(selectedValue=='1'){
          ...
          this.configName="mongodb备份"
          this.configExpression='v_mongodb_prop,name,id';
        }
