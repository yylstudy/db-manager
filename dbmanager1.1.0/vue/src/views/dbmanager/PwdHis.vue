  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      <a-form-model layout="inline" :model="queryParam">
        <a-row :gutter="10">
          <a-col :md="6" :sm="12">
            <a-form-model-item label="重置开始时间"  style="margin-left:8px">
              <a-date-picker v-model="queryParam.queryDateStart" format="YYYY-MM-DD" valueFormat="YYYY-MM-DD" placeholder="请选择重置开始时间" />
            </a-form-model-item>
          </a-col>
          <a-col :md="6" :sm="12">
            <a-form-model-item label="重置结束时间"  style="margin-left:8px">
              <a-date-picker v-model="queryParam.queryDateEnd" format="YYYY-MM-DD" valueFormat="YYYY-MM-DD" placeholder="请选择重置结束时间" />
            </a-form-model-item>
          </a-col>
          <a-col :md="6" :sm="12">
          ...
          <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
            <a-col :md="6" :sm="24">
             <a-button type="primary" @click="searchQuery" icon="search" style="margin-left: 18px">查询</a-button>
              ...
              <a-button type="primary" @click="exportExcel" icon="plus" style="margin-left: 8px">导出</a-button>
            </a-col>
          </span>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    methods: {
      ...
      exportExcel(){
        ...
        downFile("/passwordHis/exportExcel",params).then((data)=>{
          let url = window.URL.createObjectURL(new Blob([data],{type: 'application/vnd.ms-excel'}))
          let link = document.createElement('a')
          link.style.display = 'none'
          link.href = url
          link.setAttribute('download', '密码修改历史.xls')
