    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" slot="detail" :rules="validatorRules">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="数据源" :labelCol="labelCol" :wrapperCol="wrapperCol" :span="24">
              <el-cascader style="width: 500px" :filterable="true" :options="provs"  @change="initDatabase"  size="small" v-model="model.mysqlUserId"  :disabled="this.disabled"></el-cascader>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="ibd/frm储存目录" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="ibdFrmDir">
              <a-input v-model="model.ibdFrmDir" placeholder="请输入ibd/frm储存目录"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
